...
Label information can be accessed using the `ndctl` command utility which needs to be installed within the guest. See the [NDCTL Users Guide](https://docs.pmem.io/ndctl-user-guide/) for more details.
